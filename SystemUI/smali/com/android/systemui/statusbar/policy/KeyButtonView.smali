...
.method public setInfo(Lcom/android/systemui/statusbar/NavigationButtons$ButtonInfo;Z)V
    .locals 7
    ...
    iget v5, p1, Lcom/android/systemui/statusbar/NavigationButtons$ButtonInfo;->contentDescription:I

    invoke-virtual {v2, v5}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {p0, v5}, Lcom/android/systemui/statusbar/policy/KeyButtonView;->setContentDescription(Ljava/lang/CharSequence;)V

    .line 216
    iget v5, p1, Lcom/android/systemui/statusbar/NavigationButtons$ButtonInfo;->keyCode:I

    iput v5, p0, Lcom/android/systemui/statusbar/policy/KeyButtonView;->mCode:I

    .line 217
    sget-object v5, Lcom/android/systemui/statusbar/phone/NavbarEditor;->smallButtonIds:[I
    ...
    .line 220
    iget v5, p1, Lcom/android/systemui/statusbar/NavigationButtons$ButtonInfo;->sideResource:I
    ...
    .line 229
    .local v1, keyD:Landroid/graphics/drawable/Drawable;
    :goto_0
    invoke-virtual {p0, v1}, Lcom/android/systemui/statusbar/policy/KeyButtonView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    .line 230
    sget-object v5, Lcom/android/systemui/statusbar/NavigationButtons;->EMPTY:Lcom/android/systemui/statusbar/NavigationButtons$ButtonInfo;
    ...
    :goto_1
    invoke-virtual {p0, v3}, Lcom/android/systemui/statusbar/policy/KeyButtonView;->setVisibility(I)V
    ...
    .line 221
    .end local v1           #keyD:Landroid/graphics/drawable/Drawable;
    :cond_1
    if-nez p2, :cond_2

    .line 222
    iget v5, p1, Lcom/android/systemui/statusbar/NavigationButtons$ButtonInfo;->portResource:I

    invoke-virtual {v2, v5}, Landroid/content/res/Resources;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    .restart local v1       #keyD:Landroid/graphics/drawable/Drawable;
    goto :goto_0

    .line 224
    .end local v1           #keyD:Landroid/graphics/drawable/Drawable;
    :cond_2
    iget v5, p1, Lcom/android/systemui/statusbar/NavigationButtons$ButtonInfo;->landResource:I
    ...
    .line 236
    :cond_6
    sget-object v5, Lcom/android/systemui/statusbar/NavigationButtons;->CONDITIONAL_MENU:Lcom/android/systemui/statusbar/NavigationButtons$ButtonInfo;
