...
.method private pickBean()V
    ...
    .line 192
    iget-object v7, p0, Lcom/android/systemui/BeanBag$Board$Bean;->this$0:Lcom/android/systemui/BeanBag$Board;

    #getter for: Lcom/android/systemui/BeanBag$Board;->mIsCid:Z
    invoke-static {v7}, Lcom/android/systemui/BeanBag$Board;->access$000(Lcom/android/systemui/BeanBag$Board;)Z

    move-result v7

    if-eqz v7, :cond_2

    sget-object v7, Lcom/android/systemui/BeanBag$Board;->CIDS:[I
    ...
    sget-object v7, Lcom/android/systemui/BeanBag$Board;->CIDCOLORS:[I
    ...
    .end local v1           #M:[F
    .end local v2           #bean:Landroid/graphics/drawable/BitmapDrawable;
    .end local v3           #beanBits:Landroid/graphics/Bitmap;
    .end local v4           #beanId:I
    ...
    .line 207
    .restart local v2       #bean:Landroid/graphics/drawable/BitmapDrawable;
    .restart local v3       #beanBits:Landroid/graphics/Bitmap;
    .restart local v4       #beanId:I
    .restart local v6       #pt:Landroid/graphics/Paint;
    :cond_3
...
.method public reset()V
    ...
    invoke-static {v3}, Lcom/android/systemui/BeanBag$Board;->access$200(Lcom/android/systemui/BeanBag$Board;)I
